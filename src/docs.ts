/* =============================================================================
   ...
   startup sequencer (app lock -> license agreement -> auto-changelog) and
   calls into lockscreen.ts (showLockScreen) and back into shell.ts core
   (maybeShowBackupReminder — Auto-Backup's reminder nag isn't legal/about
   content, so it stays in core shell.ts despite living right next to this

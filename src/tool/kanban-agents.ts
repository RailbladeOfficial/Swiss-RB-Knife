...
export const AGENT_CLIENTS: readonly AgentClient[] = [
  ...
  },
  {
    ...
    label: "Codex",
    format: "codexToml",
    where: "~/.codex/config.toml, or .codex/config.toml in a trusted project",
    cli: true,
  },
  {
    id: "gemini-cli",
    label: "Gemini CLI",
    format: "mcpServers",
    where: "~/.gemini/settings.json, or .gemini/settings.json in your project",
    cli: true,
  },
  {
    id: "cursor",
    label: "Cursor",
    format: "mcpServers",
    where: "~/.cursor/mcp.json, or .cursor/mcp.json in your project",
    cli: false,
  },
  {
    id: "windsurf",
  ...
  },
  {
    ...
    label: "VS Code",
    format: "vscode",
    where: ".vscode/mcp.json in your project",
    cli: false,
  },
];
